              ...
              <Card key={group.category} className="bg-zinc-900/50 border-zinc-800 overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1">
                    ...
                    />
                    <span className="font-medium text-white text-sm md:text-base truncate">{group.category}</span>
                  </div>
                  <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
                    ...
                    <span 
                      className="px-2 py-0.5 md:py-1 rounded-full text-xs md:text-sm font-medium whitespace-nowrap"
                      style={{ 
                      ...
                      {group.products.map((product) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <span className="text-sm font-medium" style={{ color: categoryColors[group.category] || "#95A5A6" }}>
                              {formatCurrency(product.purchasePrice)}
                            </span>
                          </div>
                          
                          {/* Actions - always visible, aligned */}
